...
public class CharacterData : ScriptableObject
{
    ...
    public Texture bodyTex { get { return bodyTexture; } private set { bodyTexture = value; } }
    ...
    {
        Vector3[] bodyPoses = new Vector3[6];
    ...
    {
        Vector2[] uvPoses = new Vector2[12];

        uvPoses[0       ] = new Vector2(0f, 0.75f);
        uvPoses[0 + 6   ] = new Vector2((bodySizeArray[0].x + bodySizeArray[0].z) * 2f * multiplier, 0.75f);

        uvPoses[1       ] = new Vector2((bodySizeArray[5].x + bodySizeArray[5].z) * 2f * multiplier, 0.5f);
        uvPoses[1 + 6   ] = new Vector2((bodySizeArray[5].x + bodySizeArray[5].z) * 2f * multiplier, 0.25f);
        
        uvPoses[2       ] = new Vector2(0.5f, 0f);
        uvPoses[2 + 6   ] = new Vector2(0.5f + (bodySizeArray[2].x + bodySizeArray[2].z) * 2f * multiplier, 0f);
        
        uvPoses[3       ] = new Vector2((bodySizeArray[5].x + bodySizeArray[5].z + bodySizeArray[1].x + bodySizeArray[1].z) * 2f * multiplier, 0.5f);
        uvPoses[3 + 6   ] = new Vector2((bodySizeArray[5].x + bodySizeArray[5].z + bodySizeArray[1].x + bodySizeArray[1].z) * 2f * multiplier, 0.25f);
        
        uvPoses[4       ] = new Vector2((bodySizeArray[4].x + bodySizeArray[4].z) * 2f * multiplier, 0f); 
        uvPoses[4 + 6   ] = new Vector2(0f, 0f);

        uvPoses[5       ] = new Vector2(0f, 0.5f);
        uvPoses[5 + 6   ] = new Vector2(0f, 0.25f);
